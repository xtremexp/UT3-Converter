 ...
 * @author Hyperion
 */
public class SupU2ToUT3Classes extends SupportedClasses{
    ...
    public SupU2ToUT3Classes(boolean bweap,boolean bvolumes,boolean bnavpts,boolean bter,boolean bothers,boolean bhppck,boolean bamm) {
        super(new ArrayList());
        if(bweap){addWeapons();}
    ...
    private void addOthers()
    {
        ...
        super.addClass("ResizableStaticMesh");
