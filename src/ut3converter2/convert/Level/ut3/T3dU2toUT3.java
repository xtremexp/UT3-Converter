 ...
 * @author Hyperion
 */
public class T3dU2toUT3 extends T3DConvertor {

    final String xmlreffile=Main.installfolder.getAbsolutePath()
            +File.separator+"Conf"+File.separator+"U2"+File.separator+"U2ClassesDB.xml";
    ClassAnalyzer ca;
    
    final String tskname = "\n*** Conversion of U2 T3D Level to UT3 T3D Level ***";
    int uvscalefactor = 1;
    ...
    public T3dU2toUT3(File u2t3dfile, File outputfile, MapConverter mc, String pacname) {
        ...
        setTaskname(tskname);
        setBShowLog(true);
        ca = new ClassAnalyzer(new File(xmlreffile));
        ca.setStaticMeshClasses(new String[]{"U2Decoration","StaticMeshActor"});
    }
    ...
    public void convert() throws FileNotFoundException, IOException {
        ...
        bfr = new BufferedReader(new FileReader(u2t3dfile));
        ...
        try {
            ...
            System.out.println("-----> " + u2t3dfile.getAbsolutePath());
        ...
        while ((line = bfr.readLine()) != null) {
            try {
                ...
                if (line.contains(" Texture=")) {
                    ...
                    //TODO FIX Physics Volume do not work with u2
